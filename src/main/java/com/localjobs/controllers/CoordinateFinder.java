...
public class CoordinateFinder {
	...
	public double[] find(String location) throws Exception{
		...
		Document document = Jsoup.connect("http://www.findlatitudeandlongitude.com/?loc="+location).get();
		...
		int indexOf = StringUtils.indexOf(text, "Selected Location (Approximate)");
		if(indexOf == -1){
			return new double[]{};
		}

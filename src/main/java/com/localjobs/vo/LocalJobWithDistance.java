...
public class LocalJobWithDistance {
  ...
  public String toJson() {
    return new JSONSerializer().include("job").include("distance").include("duration").exclude("*.class")
      .serialize(this);
  }
  ...
  public static LocalJobWithDistance fromJson(String json) {
    return new JSONDeserializer<LocalJobWithDistance>().use(null, LocalJobWithDistance.class)
      .use("job", Job.class).use("distance", Distance.class).use("duration", Duration.class).deserialize(json);
  }
  ...
  public static Collection<LocalJobWithDistance> fromJsonArray(String json) {
    return new JSONDeserializer<List<LocalJobWithDistance>>().use(null, ArrayList.class).use("job", Job.class)
